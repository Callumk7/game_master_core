...
config :game_master_core, :scopes,
  user: [
    default: true,
...
config :game_master_core, GameMasterCoreWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: GameMasterCoreWeb.ErrorHTML, json: GameMasterCoreWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: GameMasterCore.PubSub,
  live_view: [signing_salt: "QxkVN4kZ"]
