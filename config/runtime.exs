...
#
#     PHX_SERVER=true bin/game_master_core start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :game_master_core, GameMasterCoreWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :game_master_core, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  uploads_directory =
    System.get_env("RAILWAY_VOLUME_MOUNT_PATH") || System.get_env("UPLOADS_DIRECTORY") ||
      "/uploads"
