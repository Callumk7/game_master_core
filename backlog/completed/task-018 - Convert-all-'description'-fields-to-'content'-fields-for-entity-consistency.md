...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 All database description fields renamed to content in schema definitions
- [x] #2 All description_plain_text fields renamed to content_plain_text
- [x] #3 All related tests updated to use content field names
- [x] #4 Swagger documentation updated to reflect content field naming
- [x] #5 Database migrations updated in place (no retention strategy needed)
- [x] #6 Database reset performed after migration updates
- [x] #7 All API endpoints updated to use content field naming
- [x] #8 All frontend references updated to use content field naming
<!-- AC:END -->
...
<!-- SECTION:NOTES:BEGIN -->
Successfully migrated all entity 'description' fields to 'content' fields for consistency. Updated migrations, schemas, JSON helpers, Swagger documentation, and all test files. Database reset successfully and basic tests are passing.
<!-- SECTION:NOTES:END -->
