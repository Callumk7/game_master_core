  ...
  defmacro __using__(_opts) do
    quote do
      ...
      swagger_path :update_visibility do
        put("/api/games/{game_id}/quests/{quest_id}/visibility")
        summary("Update quest visibility")
        description("Change the visibility level of a quest (private, viewable, or editable)")
        operation_id("updateQuestVisibility")
        tag("GameMaster")
        consumes("application/json")
        produces("application/json")
      ...
      swagger_path :share do
        post("/api/games/{game_id}/quests/{quest_id}/share")
        summary("Share quest with user")

        description(
          "Grant another user explicit permission to access this quest (editor, viewer, or blocked)"
        )

        operation_id("shareQuest")
        tag("GameMaster")
        consumes("application/json")
        produces("application/json")
      ...
      swagger_path :unshare do
        PhoenixSwagger.Path.delete("/api/games/{game_id}/quests/{quest_id}/share")
        summary("Remove quest share")
        description("Remove explicit permission that was granted to another user")
        operation_id("unshareQuest")
        tag("GameMaster")
      ...
      swagger_path :list_shares do
        get("/api/games/{game_id}/quests/{quest_id}/shares")
        summary("List quest shares")
        description("Get all users who have been granted explicit access to this quest")
        operation_id("listQuestShares")
        tag("GameMaster")
