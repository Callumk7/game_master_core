  ...
  defmacro __using__(_opts) do
    quote do
      ...
      swagger_path :update_visibility do
        put("/api/games/{game_id}/characters/{character_id}/visibility")
        summary("Update character visibility")
        description("Change the visibility level of a character (private, viewable, or editable)")
        operation_id("updateCharacterVisibility")
        tag("GameMaster")
        consumes("application/json")
        produces("application/json")
      ...
      swagger_path :share do
        ...
        description(
          "Grant another user explicit permission to access this character (editor, viewer, or blocked)"
        )

        operation_id("shareCharacter")
        tag("GameMaster")
        consumes("application/json")
        produces("application/json")
      ...
      swagger_path :unshare do
        PhoenixSwagger.Path.delete("/api/games/{game_id}/characters/{character_id}/share")
        summary("Remove character share")
        description("Remove explicit permission that was granted to another user")
        operation_id("unshareCharacter")
        tag("GameMaster")
      ...
      swagger_path :list_shares do
        ...
        summary("List character shares")
        description("Get all users who have been granted explicit access to this character")
        operation_id("listCharacterShares")
        tag("GameMaster")
