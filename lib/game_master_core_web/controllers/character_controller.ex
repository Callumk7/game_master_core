defmodule GameMasterCoreWeb.CharacterController do
  ...
  def update(conn, %{"id" => id, "character" => character_params}) do
    with {:ok, character} <- Characters.fetch_character_for_game(conn.assigns.current_scope, id),
         :ok <-
           Bodyguard.permit(Characters, :update_character, conn.assigns.current_scope.user, character),
  ...
  def delete(conn, %{"id" => id}) do
    with {:ok, character} <- Characters.fetch_character_for_game(conn.assigns.current_scope, id),
         :ok <-
           Bodyguard.permit(Characters, :delete_character, conn.assigns.current_scope.user, character),
