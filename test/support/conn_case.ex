defmodule GameMasterCoreWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use GameMasterCoreWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import GameMasterCoreWeb.ConnCase
    end
  end

  setup tags do
    GameMasterCore.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    user = GameMasterCore.AccountsFixtures.user_fixture()
    scope = GameMasterCore.Accounts.Scope.for_user(user)
  ...
  """
  def register_and_log_in_user_with_game(%{conn: _conn} = context) do
