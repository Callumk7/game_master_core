defmodule GameMasterCore.LinksTest do
  ...
  describe "link/2 and unlink/2 - Character and Note" do
    ...
    test "successfully links a note and character (order doesn't matter)", %{character: character, note: note} do
    ...
    test "successfully unlinks a note and character (order doesn't matter)", %{character: character, note: note} do
      {:ok, _link} = Links.link(character, note)
      assert Links.linked?(character, note)
  ...
  describe "links_for/1 - Character and Note" do
    ...
    test "returns all linked notes for a character", %{character: character, note1: note1, note2: note2} do
